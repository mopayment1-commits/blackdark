...
_EXTENSION_ID_BINDINGS: dict[int, tuple[str, str, str]] = {
    ...
    650: ("bd_platform.charting_market_intelligence_layer", "bi_connectors_383", "symbol"),
...
_EXTENSION_KEYWORD_RULES: tuple[tuple[tuple[str, ...], tuple[str, str, str]], ...] = (
    ...
    (("bi connector", "tableau", "looker", "power bi"), ("bd_platform.charting_market_intelligence_layer", "bi_connectors_383", "symbol")),
