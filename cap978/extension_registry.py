...
_EXTENSION_KEYWORD_RULES: tuple[tuple[tuple[str, ...], tuple[str, str, str]], ...] = (
    ...
    (("mcp", "ai agent", "prompt-to-sql", "prompt to sql"), ("graphql_schema", "health", "none")),
    ...
    (("methodology registry", "metric methodology"), ("data_provenance_score", "compute_data_provenance_score", "symbol")),
    (("source data provenance", "provenance"), ("data_provenance_score", "compute_data_provenance_score", "symbol")),
    ...
    (("comparable", "margin", "take rate"), ("bd_platform.market_rankings", "market_rankings", "none")),
