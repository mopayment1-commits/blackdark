#!/usr/bin/env python3
"""Generate cap646/batch06_dedicated.py for official Batch 06 (IDs 251–300)."""
...
OUT = ROOT / "cap646" / "batch06_dedicated.py"
...
def main() -> None:
    ...
    header = '''"""Batch 06 prep dedicated backends — IDs 251–300 (Run 015 opening)."""
