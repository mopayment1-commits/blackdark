...
BINDINGS: dict[str, dict] = {
    ...
    "BILL-045": {"domain": "enterprise_terms", "module_paths": ["billing/seat_enforcement.py", "institutional_commerce.py"], "reuse": "REUSE", "gate": "BLOCKED_BY_OWNER_DECISION"},
    "BILL-046": {"domain": "multi_currency", "module_paths": ["billing/price_versioning.py"], "reuse": "REUSE", "gate": "BLOCKED_BY_OWNER_DECISION"},
