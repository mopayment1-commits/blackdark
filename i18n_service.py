...
EN: dict[str, str] = {
    ...
    "login.name": "Name",
    "login.password_hint": "Password (8+ chars)",
    "login.submit": "Login",
    ...
    "login.lead": "Login or create an account. Email + password (Google when configured). 7-day Decision Pro trial on signup. USD billing via hosted Lemon/Stripe — card data never touches us.",
...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "zh-CN": {
        ...
        "login.tab.login": "登录", "login.tab.register": "注册", "login.email": "邮箱", "login.password": "密码",
        "login.name": "姓名", "login.password_hint": "密码（至少 8 位）", "login.submit": "登录",
