...
EN: dict[str, str] = {
    ...
    "error.generic": "Something went wrong. Try again or contact support if this continues.",
    "error.validation": "Please check your input and try again.",
    "error.validation.field": "This field has an error.",
    "error.auth.generic_failure": "Sign-in failed. Check your details or use account recovery.",
    "error.authz.denied": "You do not have permission to perform this action.",
    "error.security.blocked": "This action cannot be completed for security reasons.",
    "error.rate_limit": "Too many requests in a short time. Try again in {seconds} seconds.",
    "error.network.unavailable": "This service is temporarily unavailable.",
    "error.market_data.delayed": "Market data is delayed.",
    "error.data.partial": "Some data is missing or incomplete.",
    "error.payment.indeterminate": "We received your request but cannot confirm the outcome yet. Do not resubmit now — we will verify automatically.",
    "error.payment.declined": "Payment could not be completed. Update your payment method and try again.",
    "error.ai.presentation": "The analytical explanation could not be generated right now. Core data may still be available.",
    "error.ai.evidence": "A reliable analysis cannot be issued because required data is incomplete.",
    "error.decision.abstain": "There is not enough evidence to issue a reliable decision right now.",
    "error.maintenance": "Planned maintenance is in progress.",
    "error.offline": "You appear to be offline. We will reconnect automatically.",
    "error.offline.cached": "You are viewing the last available data.",
    "error.upstream.bad_gateway": "An upstream service returned an error.",
    "error.upstream.timeout": "The request timed out. Try again shortly.",
    "error.reconciliation.pending": "We are verifying the outcome of your request.",
    "error.incident.banner": "Some platform components are currently affected.",
    "error.incident.aggregated": "Multiple components are affected by the same issue.",
    "error.component.degraded": "This section is temporarily unavailable. The rest of the platform continues to operate.",
    "error.widget.unavailable": "This module is temporarily unavailable.",
    "error.support.reference": "Support reference: {reference}",
    "error.view_status": "View status",
    "error.action.retry": "Retry",
    "error.action.check_status": "Check status",
    "dts.why_not.rejected": "Expected value does not clear the required safety margin after costs and execution risk.",
    "dts.why_not.abstained": "There is not enough reliable evidence to issue a decision right now.",
    "dts.six_heroes.brief": "Today's decision brief — capital, risk, and best verified opportunity.",
    "dts.daily_autopsy.title": "Daily evidence autopsy",
    "dts.no_decision": "NO DECISION — insufficient or conflicting evidence.",
    "dts.rejected_opportunity": "BLACKDARK rejected this opportunity after truth checks.",
    "dts.safety_floor": "Safety floor: freshness, quality, evidence, and execution feasibility must pass.",
    "dts.evidence_trail": "Full evidence trail",
    "dts.simulation_disclosure": "Historical simulation — no future guarantee.",
    "dts.calibration_weak": "Calibration is weak — treat confidence with caution.",
    "dts.calibration_insufficient": "Insufficient calibration sample.",
    "dts.pre_impact_warning": "This opportunity may materially increase your risk-budget breach probability.",
    "dts.scorecard.unavailable": "Unavailable — not applicable for this decision type.",
