...
EN: dict[str, str] = {
    ...
    "pricing.not_advice": "Not financial advice; we do not guarantee accuracy. Read the",
    "pricing.refund": "Refund Policy",
    "pricing.billing_checking": "Checking payment readiness…",
    "pricing.free.b1": "Trust Pulse + OQS Why",
    "pricing.free.b2": "Shareable Decision Certificate",
    "pricing.free.b3": "3 certified decisions / day",
    "pricing.free.b4": "Public Accuracy Ledger",
    "pricing.free.b5": "Free Proof watermark",
    "pricing.pro.b1": "Unlimited certified Oracle",
    "pricing.pro.b2": "Since-you-left continuity",
    "pricing.pro.b3": "Portfolio AI + alerts",
    "pricing.pro.b4": "AI Chat · no Free watermark",
    "pricing.pro.b5": "Research Lab + Arbitrage",
    "pricing.desk.b1": "Everything in Decision Pro",
    "pricing.desk.b2": "Whale Signal vs Noise",
    "pricing.desk.b3": "Stealth advisory views",
    "pricing.desk.b4": "Evidence Pack + API priority",
    "pricing.inst.b1": "Data Room + Compliance pack",
    "pricing.inst.b2": "SSO / enforced MFA",
    "pricing.inst.b3": "SLA · Integration Addendum",
    "inst.form.title": "Institutional inquiry (USD wire / invoice)",
    "inst.form.email": "Work email",
    "inst.form.name": "Name",
    "inst.form.firm": "Firm",
    "inst.form.budget": "Budget band USD",
    "inst.form.usecase": "Use case",
    "inst.form.email_ph": "work@fund.com",
    "inst.form.budget_ph": "Budget band USD (e.g. from 3000)",
    "inst.form.usecase_ph": "Use case / seats / SLA needs",
    "waitlist.title": "Get early access to Trust OS",
    "waitlist.sub": "Join the waitlist for launch updates. No fake seat counters — just a clear path to Prove.",
