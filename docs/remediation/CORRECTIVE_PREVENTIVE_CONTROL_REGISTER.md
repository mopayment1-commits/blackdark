...
| 8 | Required target behavior | Add mandatory gate_scope enum PILOT\|INSTITUTIONAL_24H to G3 assessment JSON; reject institutional claims when scope ≠ INSTITUTIONAL_24H. |
...
| 8 | Required target behavior | Document INFRA_PROFILE=minimal\|full with explicit kafka/redis/vault requirements per feature. |
...
| 8 | Required target behavior | Commit sandbox fixture keys under tests/fixtures/keys/; KEYS_MODE=fixture\|live boundary documented. |
