...
## النسخة السادسة — Deep Point-by-Point Institutional Validation — 6 سبتمبر 2026

> **Integration update — 7 سبتمبر 2026:** تم دمج متطلبات **BLACKDARK Completion & Real-Capability Standard — النسخة المنقحة النهائية** داخل هذا المرجع على أساس delta-only، مع اعتماد **v6** كالمرجع المؤسسي الحاكم الأعلى الحالي للمشروع، ومنع إنشاء SSOT موازٍ أو تكرار متطلبات موجودة أصلًا. **v5** محفوظ كمرجع تاريخي **superseded** وليس governing. **Domain Specification** وأي معايير فرعية تبقى **subordinate** لـv6.

> **تحديث v5 (تاريخي — superseded):** مراجعة مستقلة نقطةً بنقطة لجميع أقسام v4، مع إعادة التحقق من حداثة وسلطة المراجع حتى 6 سبتمبر 2026، وتصحيح التصنيفات التي قد توحي خطأً بأن إرشادًا أو benchmark هو معيار ملزم. v5 يحتفظ بجوهر v4 لكنه يضيف سجل صلاحية للمراجع، وحدود الانطباق التنظيمي، ومصفوفة مراجعة 0–135، ويحدّث DORA إلى نموذج المقاييس الخمسة الحالي. **أُ supersede بـv6؛ لا يُستخدم v5 كمرجع حاكم.**
...
**v6 هو المرجع المؤسسي الحاكم الأعلى الحالي للمشروع.**

**v5** كان المرجع الحاكم بعد المراجعة العميقة لجميع محتويات v4، ويُحفظ الآن كمرجع تاريخي **superseded** وليس governing. **Domain Specification** وأي معايير فرعية تبقى **subordinate** لـv6.
...
> **[POLICY]** هذا القسم يضيف فقط قواعد المشروع التي لم تكن مثبتة بصراحة في v5 (النسخة التاريخية superseded) قبل هذا الدمج. جميع متطلبات صحة القدرة، الدليل، full-path، التكرار، الأبطال الستة، الأمن، البيانات، الأداء، regression، الضمان، وAnti-Bureaucracy تبقى محكومة بالأقسام الأصلية أعلاه دون إعادة نسخها هنا.
