# مطابقة فورية — نص التقرير الملصق ↔ التنفيذ

> مقابل النص الذي أعاد المالك لصقه في 2026-08-06  
> المرجع: [`الملف_المرجعي_الملزم.md`](./الملف_المرجعي_الملزم.md) · المصدر: [`SOURCE_BINDING_REPORT_AR.md`](./SOURCE_BINDING_REPORT_AR.md)

| بند التقرير | حكم التنفيذ | متاح للمستخدم؟ | أين |
|-------------|-------------|----------------|-----|
| Prove it / Public Accuracy Ledger | DONE | نعم | `/oracle-accuracy` |
| MEV/Sandwich قابل للمشاركة | DONE | نعم | Dashboard + `/api/mev/sandwich-report` |
| Glass Box Challenge (منتج Locked + حزمة) | DONE | نعم | `#glass-box-challenge` · `#locked` |
| Glass Box (توقيت/قناة الإطلاق) | LAUNCH_ONLY | لا كحدث معلن | يحتاج قرارك (H2) |
| Dashboard Tourism → Single-Sentence Oracle | DONE | نعم | `/` |
...
| 60/30/10 | قاعدة وكلاء | — | ملزم |
| معيار 60 ثانية | معيار إطلاق | تحقق بشري | H3 |
| هـ1 Locked / لحظة صاروخ | DONE عبر ز1 | نعم | `#locked` |
