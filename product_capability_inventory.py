...
def capability_catalog() -> list[dict[str, Any]]:
    return [
        ...
        _f(id="BIL-CHECKOUT", name="Self-serve checkout Stripe/Lemon", name_ar="دفع ذاتي Stripe/Lemon", domain="billing", status="ops_config", personas=["pro", "whale"], surfaces=["/api/billing/checkout", "/create-checkout-session", "/webhook"], evidence="api/routers/billing.py", efficiency="Code complete; live charge needs owner PSP secrets", unpaid_block="psp_credentials"),
