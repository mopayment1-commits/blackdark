...
LENSES: list[dict[str, Any]] = [
    {
        ...
        "hide_sections": ["arbitrage", "stealth", "mev", "desk_tools", "half_life_clock"],
        "soft_sections": ["my_book", "alerts"],  # teaser / upgrade
        "viral_role": "Each Proof Card is an invite — share why this decision was made. Kill-Rate + Arena amplify refusal proof.",
        "viral_surfaces": ["/kill-rate", "/contradiction-replay", "/proof-arena"],
