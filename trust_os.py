...
OVERCLAIM_DENYLIST: list[dict[str, str]] = [
    ...
    {"claim": "100 APIs / Financial Truth Layer as the product", "truth": "Quiet Data Trust Law under Oracle — catalog size is not coverage"},
    {"claim": "CoinGecko L2 / synthetic books as executable depth", "truth": "Honesty gate: aggregators are fallback/discovery only"},
...
def strategy_correction_manifest() -> dict[str, Any]:
    ...
    return {
        ...
        "not_building": [
            ...
            "hundred_source_ingestion_swamp",
