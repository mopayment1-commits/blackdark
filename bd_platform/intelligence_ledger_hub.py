...
def _default_query_params(module_id: str) -> list[dict[str, Any]]:
    defaults: dict[str, list[dict[str, Any]]] = {
        ...
        "portfolio-ai/capital-awareness": [{"name": "portfolio_id", "default": "demo_portfolio", "label": "Portfolio"}],
        "intelligence-layer/capital-awareness/risk-assessment": [{"name": "signal_id", "default": "sig_btc_momentum", "label": "Signal"}],
        "portfolio-ai/strategy-simulator/apply-signal": [{"name": "signal_id", "default": "sig_btc_momentum", "label": "Signal"}],
