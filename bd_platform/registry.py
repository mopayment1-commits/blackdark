...
FEATURE_MATRIX: list[dict[str, Any]] = [
    ...
    {"id": 15, "key": "onchain_extended", "title": "Extended on-chain (DexScreener+Gecko)", "module": "bd_platform.onchain_hub", "endpoint": "/api/platform/onchain/pairs", "refs": ["DexScreener", "GeckoTerminal", "Dune", "Arkham", "Santiment"]},
    ...
    {"id": 17, "key": "lunarcrush", "title": "LunarCrush social metrics", "module": "bd_platform.onchain_hub", "endpoint": "/api/platform/social/lunarcrush", "refs": ["LunarCrush", "socialtickers"], "env_keys": ["LUNARCRUSH_API_KEY"], "free_tier": "socialtickers.com (no key)"},
    {"id": 18, "key": "coinmarketcal", "title": "Crowdsourced event calendar", "module": "bd_platform.onchain_hub", "endpoint": "/api/platform/events/calendar", "refs": ["CoinMarketCal", "DeFiLlama"], "env_keys": ["COINMARKETCAL_API_KEY"], "free_tier": "free key at developers.coinmarketcal.com"},
    {"id": 19, "key": "debank_wallet", "title": "Multi-EVM wallet dashboard", "module": "bd_platform.onchain_hub", "endpoint": "/api/platform/wallet/debank", "refs": ["DeBank", "Tracely", "Zerion"], "env_keys": ["DEBANK_API_KEY", "ZERION_API_KEY"], "free_tier": "tracely.live portfolio (no key)"},
    {"id": 20, "key": "bubblemaps", "title": "Wallet cluster visualization", "module": "bd_platform.onchain_hub", "endpoint": "/api/platform/wallet/clusters", "refs": ["Bubblemaps", "Tracely"], "env_keys": ["BUBBLEMAPS_API_KEY"], "free_tier": "tracely.live graph clusters (no key)"},
    {"id": 21, "key": "geckoterminal", "title": "GeckoTerminal pairs", "module": "bd_platform.onchain_hub", "endpoint": "/api/platform/defi/geckoterminal", "refs": ["GeckoTerminal"]},
    ...
    {"id": 24, "key": "scopescan", "title": "0xScope / Scopescan labels", "module": "bd_platform.onchain_hub", "endpoint": "/api/platform/wallet/scopescan", "refs": ["0xScope", "Scopescan", "eth-labels"], "env_keys": ["SCOPESCAN_API_KEY"], "free_tier": "tracely + eth-labels.com (no key)"},
    ...
    {"id": 27, "key": "defillama_raises", "title": "DeFiLlama raises / funding", "module": "bd_platform.onchain_hub", "endpoint": "/api/platform/defi/raises", "refs": ["DeFiLlama", "The Block Pro"]},
    {"id": 28, "key": "lookintobitcoin", "title": "Bitcoin macro cycle indicators", "module": "bd_platform.onchain_hub", "endpoint": "/api/platform/macro/bitcoin", "refs": ["LookIntoBitcoin"]},
    ...
    {"id": 30, "key": "l2beat", "title": "L2Beat security metrics", "module": "bd_platform.onchain_hub", "endpoint": "/api/platform/l2/security", "refs": ["L2Beat"]},
    ...
    {"id": 32, "key": "blockpour", "title": "Blockpour cross-chain flows", "module": "bd_platform.onchain_hub", "endpoint": "/api/platform/flows/cross-chain", "refs": ["Blockpour", "DeFiLlama"], "env_keys": ["BLOCKPOUR_API_KEY"], "free_tier": "defillama bridges OR free key at app.blockpour.com"},
    {"id": 33, "key": "intotheblock", "title": "IntoTheBlock holder profitability", "module": "bd_platform.onchain_hub", "endpoint": "/api/platform/analytics/intotheblock", "refs": ["IntoTheBlock", "CoinGecko", "Binance"], "env_keys": [], "free_tier": "CoinGecko + Binance (ITB API discontinued)"},
