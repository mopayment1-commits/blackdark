"""Hero batch 09 — official capabilities 401–450 live execution tests."""
...
@pytest.mark.asyncio
async def test_batch_09_capability_executes(capability_id: int):
...
def test_batch_09_manifest_count():
