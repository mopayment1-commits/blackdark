"""Batch09 full-path local integration — cap646 runtime with entitlement checks."""
...
PRO_USER = {"id": 1, "email": "batch09-fullpath@blackdark.local", "tier": "pro", "role": "user"}
...
@pytest.mark.parametrize("capability_id", [401, 437, 450])
@pytest.mark.asyncio
