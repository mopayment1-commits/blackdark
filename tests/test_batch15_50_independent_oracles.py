"""Independent oracles for all 50 Batch15 canonical-reuse facades."""
...
from bd_platform.batch15_prebuild_classification import CANONICAL_DUPLICATE_TARGETS as PREBUILD_TARGETS
...
@pytest.mark.parametrize("cap_id", BATCH15_IDS)
