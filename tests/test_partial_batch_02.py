"""Partial closure batch 02 — dedicated execute smoke for bound capabilities."""
...
_MANIFEST = Path(__file__).resolve().parent.parent / "scripts" / "partial_batches" / "batch_02.json"
...
@pytest.mark.asyncio
async def test_partial_batch_02_capability_executes(capability_id: int):
