"""Hero batch 03 — capabilities 201–300 live execution tests."""
...
MANIFEST = ROOT / "scripts" / "partial_batches" / "batch_03_201_300.json"
...
@pytest.mark.asyncio
async def test_batch_03_capability_executes(capability_id: int):
...
def test_batch_03_manifest_count():
