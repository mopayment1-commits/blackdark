"""Execute all Batch15 capability handlers — extension analytics layer coverage."""
...
def test_reset_batch15_defi_risk_data_state() -> None:
    from bd_platform.batch15_defi_risk_data_facade_layer import reset_batch15_defi_risk_data_state

    assert reset_batch15_defi_risk_data_state() is None
