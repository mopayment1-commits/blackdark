"""Hero batch 07 — official capabilities 301–350 live execution tests."""
...
@pytest.mark.asyncio
async def test_batch_07_capability_executes(capability_id: int):
...
def test_batch_07_manifest_count():
