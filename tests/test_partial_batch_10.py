"""Partial closure batch 10 — dedicated execute smoke for bound capabilities."""
...
_MANIFEST = Path(__file__).resolve().parent.parent / "scripts" / "partial_batches" / "batch_10.json"
...
@pytest.mark.asyncio
async def test_partial_batch_10_capability_executes(capability_id: int):
