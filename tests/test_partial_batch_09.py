"""Partial closure batch 09 — dedicated execute smoke for bound capabilities."""
...
_MANIFEST = Path(__file__).resolve().parent.parent / "scripts" / "partial_batches" / "batch_09.json"
...
@pytest.mark.asyncio
async def test_partial_batch_09_capability_executes(capability_id: int):
