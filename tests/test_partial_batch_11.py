"""Partial closure batch 11 — dedicated execute smoke for bound capabilities."""
...
_MANIFEST = Path(__file__).resolve().parent.parent / "scripts" / "partial_batches" / "batch_11.json"
...
@pytest.mark.asyncio
async def test_partial_batch_11_capability_executes(capability_id: int):
