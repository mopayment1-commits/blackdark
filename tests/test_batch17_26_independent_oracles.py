"""Independent oracles for all 26 Batch17 canonical-reuse facades."""
...
from bd_platform.batch17_prebuild_classification import CANONICAL_DUPLICATE_TARGETS as PREBUILD_TARGETS
