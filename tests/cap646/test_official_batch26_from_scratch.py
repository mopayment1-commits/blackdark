"""From-scratch tests — official batch26 (IDs 626–650)."""
...
@pytest.mark.asyncio
async def test_official_batch26_from_scratch(capability_id: int):
...
@pytest.mark.parametrize("capability_id", BATCH_IDS)
@pytest.mark.asyncio
async def test_official_batch26_execute(capability_id: int):
