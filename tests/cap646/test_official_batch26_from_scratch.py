"""Substantive v6 tests — official batch26 (IDs 626–650)."""
...
BATCH_IDS = [626, 627, 628, 629, 630, 631, 632, 633, 634, 635, 636, 637, 638, 639, 640, 641, 642, 643, 644, 645, 646, 647, 648, 649, 650]


@pytest.mark.parametrize("capability_id", BATCH_IDS)
@pytest.mark.asyncio
async def test_official_batch26_substantive_execute(capability_id: int):
