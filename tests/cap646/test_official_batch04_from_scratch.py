"""From-scratch tests — official batch04 (IDs 76–100)."""
...
@pytest.mark.asyncio
async def test_official_batch04_from_scratch(capability_id: int):
...
@pytest.mark.parametrize("capability_id", BATCH_IDS)
@pytest.mark.asyncio
async def test_official_batch04_execute(capability_id: int):
