"""From-scratch tests — official batch32 (IDs 776–800)."""
...
@pytest.mark.asyncio
async def test_official_batch32_from_scratch(capability_id: int):
...
@pytest.mark.parametrize("capability_id", BATCH_IDS)
@pytest.mark.asyncio
async def test_official_batch32_execute(capability_id: int):
