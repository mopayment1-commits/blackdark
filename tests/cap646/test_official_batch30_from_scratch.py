"""From-scratch tests — official batch30 (IDs 726–750)."""
...
@pytest.mark.asyncio
async def test_official_batch30_from_scratch(capability_id: int):
...
@pytest.mark.parametrize("capability_id", BATCH_IDS)
@pytest.mark.asyncio
async def test_official_batch30_execute(capability_id: int):
