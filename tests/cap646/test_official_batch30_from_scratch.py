"""Substantive v6 tests — official batch30 (IDs 726–750)."""
...
BATCH_IDS = [726, 727, 728, 729, 730, 731, 732, 733, 734, 735, 736, 737, 738, 739, 740, 741, 742, 743, 744, 745, 746, 747, 748, 749, 750]


@pytest.mark.parametrize("capability_id", BATCH_IDS)
@pytest.mark.asyncio
async def test_official_batch30_substantive_execute(capability_id: int):
