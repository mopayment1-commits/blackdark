"""From-scratch tests — official batch27 (IDs 651–675)."""
...
@pytest.mark.asyncio
async def test_official_batch27_from_scratch(capability_id: int):
...
@pytest.mark.parametrize("capability_id", BATCH_IDS)
@pytest.mark.asyncio
async def test_official_batch27_execute(capability_id: int):
