"""From-scratch tests — official batch07 (IDs 151–175)."""
...
@pytest.mark.asyncio
async def test_official_batch07_from_scratch(capability_id: int):
...
@pytest.mark.parametrize("capability_id", BATCH_IDS)
@pytest.mark.asyncio
async def test_official_batch07_execute(capability_id: int):
