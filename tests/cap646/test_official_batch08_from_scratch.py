"""From-scratch tests — official batch08 (IDs 176–200)."""
...
@pytest.mark.asyncio
async def test_official_batch08_from_scratch(capability_id: int):
...
@pytest.mark.parametrize("capability_id", BATCH_IDS)
@pytest.mark.asyncio
async def test_official_batch08_execute(capability_id: int):
