"""From-scratch tests — official batch25 (IDs 601–625)."""
...
@pytest.mark.asyncio
async def test_official_batch25_from_scratch(capability_id: int):
...
@pytest.mark.parametrize("capability_id", BATCH_IDS)
@pytest.mark.asyncio
async def test_official_batch25_execute(capability_id: int):
