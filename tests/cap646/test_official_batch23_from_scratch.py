"""From-scratch tests — official batch23 (IDs 551–575)."""
...
@pytest.mark.asyncio
async def test_official_batch23_from_scratch(capability_id: int):
...
@pytest.mark.parametrize("capability_id", BATCH_IDS)
@pytest.mark.asyncio
async def test_official_batch23_execute(capability_id: int):
