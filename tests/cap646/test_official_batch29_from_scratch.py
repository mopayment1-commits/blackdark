"""Substantive v6 tests — official batch29 (IDs 701–725)."""
...
BATCH_IDS = [701, 702, 703, 704, 705, 706, 707, 708, 709, 710, 711, 712, 713, 714, 715, 716, 717, 718, 719, 720, 721, 722, 723, 724, 725]


@pytest.mark.parametrize("capability_id", BATCH_IDS)
@pytest.mark.asyncio
async def test_official_batch29_substantive_execute(capability_id: int):
