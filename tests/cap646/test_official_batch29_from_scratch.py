"""From-scratch tests — official batch29 (IDs 701–725)."""
...
@pytest.mark.asyncio
async def test_official_batch29_from_scratch(capability_id: int):
...
@pytest.mark.parametrize("capability_id", BATCH_IDS)
@pytest.mark.asyncio
async def test_official_batch29_execute(capability_id: int):
