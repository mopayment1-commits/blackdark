"""From-scratch tests — official batch02 (IDs 26–50)."""
...
@pytest.mark.asyncio
async def test_official_batch02_from_scratch(capability_id: int):
...
@pytest.mark.parametrize("capability_id", BATCH_IDS)
@pytest.mark.asyncio
async def test_official_batch02_execute(capability_id: int):
