"""From-scratch tests — official batch34 (IDs 826–826)."""
...
@pytest.mark.asyncio
async def test_official_batch34_from_scratch(capability_id: int):
...
@pytest.mark.parametrize("capability_id", BATCH_IDS)
@pytest.mark.asyncio
async def test_official_batch34_execute(capability_id: int):
