"""From-scratch tests — official batch18 (IDs 426–450)."""
...
@pytest.mark.asyncio
async def test_official_batch18_from_scratch(capability_id: int):
...
@pytest.mark.parametrize("capability_id", BATCH_IDS)
@pytest.mark.asyncio
async def test_official_batch18_execute(capability_id: int):
