"""Batch07 full-path local integration — cap646 runtime with entitlement checks."""
...
MANIFEST = ROOT / "scripts" / "partial_batches" / "batch_07_301_350.json"

PRO_USER = {"id": 1, "email": "batch07-fullpath@blackdark.local", "tier": "pro", "role": "user"}
...
@pytest.mark.parametrize("capability_id", [301, 316, 339])
@pytest.mark.asyncio
