"""Semantic contracts for all 50 Batch15 capabilities."""
...
from bd_platform.batch15_semantic_contracts import all_contracts, contract_for
from bd_platform.batch15_membership import BATCH15_IDS
...
def test_contracts_50_of_50() -> None:
    ...
    assert set(contracts) == set(BATCH15_IDS)


@pytest.mark.parametrize("capability_id", BATCH15_IDS)
