"""Hero batch 04 — capabilities 301–400 live execution tests."""
...
MANIFEST = ROOT / "scripts" / "partial_batches" / "batch_04_301_400.json"
...
@pytest.mark.asyncio
async def test_batch_04_capability_executes(capability_id: int):
...
def test_batch_04_manifest_count():
