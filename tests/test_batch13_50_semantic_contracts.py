"""Semantic contracts for all 50 Batch13 capabilities."""
...
from bd_platform.batch13_semantic_contracts import all_contracts, contract_for
from bd_platform.batch13_membership import BATCH13_IDS
...
def test_contracts_50_of_50() -> None:
    ...
    assert set(contracts) == set(BATCH13_IDS)


@pytest.mark.parametrize("capability_id", BATCH13_IDS)
def test_semantic_contract_runtime_match(capability_id: int) -> None:
    ...
    if contract.get("expected_ok") is False:
