"""Partial closure batch 08 — dedicated execute smoke for bound capabilities."""
...
_MANIFEST = Path(__file__).resolve().parent.parent / "scripts" / "partial_batches" / "batch_08.json"
...
@pytest.mark.asyncio
async def test_partial_batch_08_capability_executes(capability_id: int):
