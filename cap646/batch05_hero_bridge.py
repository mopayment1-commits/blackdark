...
_HERO_BINDINGS: dict[int, tuple[str, str, dict[str, Any]]] = {
    ...
    206: _binding("bd_platform.onchain_defi_sources_layer", "ingest_uniswap_subgraph_206"),
    ...
    212: _binding("bd_platform.onchain_defi_sources_layer", "hedge_effectiveness_analysis_212"),
    ...
    226: _binding("bd_platform.intelligence_market_extensions_layer", "analyze_launch_event_226"),
    227: _binding("bd_platform.intelligence_market_extensions_layer", "run_intelligence_market_extensions_e2e_217_227"),
    228: _binding("bd_platform.intelligence_ux_extensions_layer", "simulate_drawdown_hedge_228"),
    ...
    232: _binding("bd_platform.intelligence_ux_extensions_layer", "attach_arbitrage_comparison_230_232", arbitrage={"asset": "BTC"}),
