"""Invoke underlying catalog handlers for batch13 dedicated backends (no spine recursion)."""
...
async def invoke_underlying(capability_id: int, *, params: dict[str, Any] | None = None) -> dict[str, Any]:
    """Call generic domain handler for batch13 IDs — avoids batch spine re-entry."""
