...
_EXPLICIT_BINDINGS: dict[int, BackendBinding] = {
    ...
    637: BackendBinding(
        ...
        "bd_platform.batch13_operational_intelligence_layer",
        "scenario_engine_637",
        "scenario_engine_probabilistic_scenarios_not_deterministic_prediction",
        "symbol",
        "canonical_catalog_semantics",
    ),
    638: BackendBinding(
        638,
        "bd_platform.batch13_operational_intelligence_layer",
        "claims_prediction_verification_638",
        "claims_prediction_verification_engine",
        "none",
        "canonical_catalog_semantics",
    ),
    639: BackendBinding(
    ...
    641: BackendBinding(
        641,
        "bd_platform.batch13_operational_intelligence_layer",
        "decision_certificate_export_641",
        "decision_certificate_institutional_dd_export",
        "symbol",
        "canonical_catalog_semantics",
    ),
    645: BackendBinding(
        645,
        "bd_platform.batch13_operational_intelligence_layer",
        "security_verification_evidence_645",
