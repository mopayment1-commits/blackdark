...
_COMPONENT_BINDINGS: dict[str, tuple[str, str, str]] = {
    ...
    "graphql_schema.py": ("graphql_schema", "health", "none"),
...
_TRACK_DEFAULTS: dict[str, tuple[str, str, str]] = {
    ...
    "T07": ("bd_platform.portfolio_rebalancer", "suggest_rebalance", "none"),
    ...
    "T11": ("bd_platform.footprint_analytics", "footprint_snapshot", "symbol"),
...
_KEYWORD_RULES: tuple[tuple[tuple[str, ...], tuple[str, str, str]], ...] = (
    ...
    (("portfolio", "rebalance", "allocation"), ("bd_platform.portfolio_rebalancer", "suggest_rebalance", "none")),
    ...
    (("graphql", "api platform"), ("graphql_schema", "health", "none")),
