"""Official Batch 31 dedicated backends — goal-specific payloads (v6 §2.1).

Auto-generated — institutional 25-cap batch 31 (IDs 751–775).
"""
...
async def execute(capability_id: int, *, params: dict[str, Any] | None = None) -> dict[str, Any]:
    return await execute_dedicated_caps(
        ...
        dispatch=_DISPATCH,
        overlap_error="batch01 overlap for batch31",
        not_dedicated_error=f"batch31: not a dedicated capability",
    )
