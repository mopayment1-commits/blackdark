#!/usr/bin/env python3
"""Launch-57 Phase 7 Adaptive Batch A builder evidence generator (#43→#38→#49→#50→#52)."""
...
EVIDENCE_PATH = GOV / "PHASE7_ADAPTIVE_BATCH_A_EVIDENCE.json"
REPORT_PATH = GOV / "PHASE7_ADAPTIVE_BATCH_A_REPORT.md"
BUILD_ORDER = [43, 38, 49, 50, 52]
ENTRY_GATE_SHA = "0e5d37cc"
...
def _run_tests() -> dict:
    proc = subprocess.run(
        [
            ...
            "tests/launch57/test_temporal_batch6.py",
            "tests/launch57/test_temporal_batch11.py",
    ...
    return {
        "command": (
            "python3 -m pytest tests/launch57/test_phase7_adaptive_batch_a.py "
            "tests/launch57/test_edge_ui_batch1.py "
            "tests/launch57/test_edge_ui_institutional_wire.py "
            "tests/launch57/test_temporal_batch6.py "
            "tests/launch57/test_temporal_batch11.py "
            "tests/launch57/test_phase6_adaptive_batch1.py -q"
        ),
...
def main() -> None:
    ...
    evidence = {
        "artifact": "PHASE7_ADAPTIVE_BATCH_A_EVIDENCE",
        "phase": "7_ADAPTIVE_BATCH_A",
        ...
        "entry_gate": {
            ...
            "net_edge_entry_gate": {
                ...
                "evidence": "governance/launch57/PHASE2_ADAPTIVE_BATCH_A_INDEPENDENT_VERIFICATION.json",
            },
        },
    ...
    lines = [
        ...
        f"Entry gate: PHASE6_INDEPENDENT_VERDICT = PASS_ENGINEERING @ `{ENTRY_GATE_SHA}`",
        f"Net-Edge entry gate: P2A:#5 = PASS_ENGINEERING (same `net_edge_truth_score` path as #43)",
    ...
    print(f"Wrote Phase 7 Adaptive Batch A evidence @ {commit_sha[:8]}")
