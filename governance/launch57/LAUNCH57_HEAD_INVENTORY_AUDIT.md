...
| 48 | Abstain / reject reasons ظاهرة | UNMAPPED | /dashboard#trust-pulse → WAIT/ABSTAIN → GET /api/launch57/abstain-reasons (#48) | PARTIAL | جزئي | نعم `tests/launch57/test_decision_visible_batch_d.py::test_abstain_reasons_route_launch_48` | NONE | أسباب WAIT/ABSTAIN ظاهرة — لا حكم بلا سبب؛ PENDING_VERIFICATION |
