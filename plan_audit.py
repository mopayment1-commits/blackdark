...
_PLAN_ROWS: tuple[tuple[Any, ...], ...] = (
    ...
    ("core", "CEX ↔ DEX", "complete", "bd_platform.cex_dex_executor", "/api/platform/arb/cex-dex/execute", "indicative≠executable honesty"),
    ...
    ("core", "77 arbitrage types catalog", "complete", "arbitrage_catalog", "/api/arbitrage/catalog", "Catalog with honest proxy/planned labels"),
    ...
    ("ai", "Whale Intelligence", "complete", "whale_tracker", "/api/whale-activity", "CVVD + why narrative + whale_execution_evidence"),
