...
|---:|---|---|---|---|---|
| 1 | Smart Money Leaderboard | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/1/execute | BOUND | COMPLETE_V6 |
| 2 | Wallet Profiler | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/2/execute | BOUND | COMPLETE_V6 |
| 3 | Wallet Profiler for Token | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/3/execute | BOUND | COMPLETE_V6 |
| 4 | Smart Money Tracking | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/4/execute | BOUND | COMPLETE_V6 |
| 5 | Smart Money Accumulation / Distribution  | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/5/execute | BOUND | COMPLETE_V6 |
| 6 | Smart Money Token Screener | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/6/execute | BOUND | COMPLETE_V6 |
| 7 | Holder Distribution Intelligence | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/7/execute | BOUND | COMPLETE_V6 |
| 8 | Top Holders Concentration Analysis | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/8/execute | BOUND | COMPLETE_V6 |
| 9 | Distribution Score | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/9/execute | BOUND | COMPLETE_V6 |
| 10 | Wallet PnL Analysis | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/10/execute | BOUND | COMPLETE_V6 |
| 11 | Wallet Historical Performance & Win Rate | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/11/execute | BOUND | COMPLETE_V6 |
| 12 | Wallet Entry / Exit Analysis | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/12/execute | BOUND | COMPLETE_V6 |
| 13 | Wallet Counterparty & Relationship Analy | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/13/execute | BOUND | COMPLETE_V6 |
| 14 | Entity-Aware Wallet Intelligence | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/14/execute | BOUND | COMPLETE_V6 |
| 15 | Exchange Flow Intelligence | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/15/execute | BOUND | COMPLETE_V6 |
| 16 | Candle / Price-Move Investigator | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/16/execute | BOUND | COMPLETE_V6 |
| 17 | Smart Alerts | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/17/execute | BOUND | ENGINEERING_READY |
| 18 | Custom Wallet Labels | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/18/execute | BOUND | COMPLETE_V6 |
| 19 | Wallet & Token Watchlists | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/19/execute | BOUND | COMPLETE_V6 |
| 20 | Multi-Chain Portfolio Intelligence | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/20/execute | BOUND | COMPLETE_V6 |
| 21 | Transaction Decoder | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/21/execute | BOUND | COMPLETE_V6 |
| 22 | Instant Wallet Due Diligence | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/22/execute | BOUND | COMPLETE_V6 |
| 23 | Instant Token Due Diligence | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/23/execute | BOUND | COMPLETE_V6 |
| 24 | AI Research Agent Grounded in Platform D | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/24/execute | BOUND | ENGINEERING_READY |
| 25 | Signal → Explanation Workflow | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/25/execute | BOUND | ENGINEERING_READY |
| 26 | Price-Move Explanation | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/26/execute | BOUND | ENGINEERING_READY |
| 27 | Smart Money Historical Trend Analysis | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/27/execute | BOUND | ENGINEERING_READY |
| 28 | Smart Money Conviction Engine | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/28/execute | BOUND | ENGINEERING_READY |
| 29 | Cross-Market Decision Intelligence Engin | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/29/execute | BOUND | ENGINEERING_READY |
| 30 | Evidence & Confidence Layer | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/30/execute | BOUND | ENGINEERING_READY |
| 31 | Cross-Signal Confirmation | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/31/execute | BOUND | ENGINEERING_READY |
| 32 | Contradiction Detection | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/32/execute | BOUND | ENGINEERING_READY |
| 33 | Smart Money Actionability Score | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/33/execute | BOUND | ENGINEERING_READY |
| 34 | Beginner Decision Mode | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/34/execute | BOUND | ENGINEERING_READY |
| 35 | Market Compass / Market Regime Engine | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/35/execute | BOUND | ENGINEERING_READY |
| 36 | On-Chain Metrics Library | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/36/execute | BOUND | COMPLETE_V6 |
| 37 | Entity-Adjusted Metrics | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/37/execute | BOUND | COMPLETE_V6 |
| 38 | Cost Basis Distribution | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/38/execute | BOUND | COMPLETE_V6 |
| 39 | Realized Cap & Realized Price Intelligen | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/39/execute | BOUND | COMPLETE_V6 |
| 40 | MVRV / MVRV Z-Score Suite | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/40/execute | BOUND | COMPLETE_V6 |
| 41 | SOPR / Profitability Intelligence | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/41/execute | BOUND | ENGINEERING_READY |
| 42 | Holder Cohort Intelligence | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/42/execute | BOUND | COMPLETE_V6 |
| 43 | Supply Dynamics Intelligence | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/43/execute | BOUND | COMPLETE_V6 |
| 44 | Exchange Balance & Netflow Intelligence | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/44/execute | BOUND | COMPLETE_V6 |
| 45 | ETF Flow Intelligence | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/45/execute | BOUND | COMPLETE_V6 |
| 46 | Digital Asset Treasury Company Intellige | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/46/execute | BOUND | COMPLETE_V6 |
| 47 | Spot Market Metrics Suite | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/47/execute | BOUND | COMPLETE_V6 |
...
| 214 | Watchlists | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/214/execute | BOUND | COMPLETE_V6 |
...
| 252 | Liquidation Heatmap | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/252/execute | BOUND | COMPLETE_V6 |
| 253 | Liquidation Map / Levels | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/253/execute | BOUND | COMPLETE_V6 |
| 254 | Real-Time Liquidation Events | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/254/execute | BOUND | COMPLETE_V6 |
| 255 | Open Interest Intelligence | B2B Feed | /api/b2b/demo → /api/cap646/255/execute | BOUND | COMPLETE_V6 |
| 256 | Funding Rate Intelligence | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/256/execute | BOUND | COMPLETE_V6 |
| 257 | Long/Short Ratio Intelligence | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/257/execute | BOUND | COMPLETE_V6 |
| 258 | Top Trader Positioning | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/258/execute | BOUND | COMPLETE_V6 |
| 259 | Futures Basis Intelligence | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/259/execute | BOUND | COMPLETE_V6 |
| 260 | Futures Volume Intelligence | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/260/execute | BOUND | ENGINEERING_READY |
| 261 | Futures CVD / Taker Flow | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/261/execute | BOUND | COMPLETE_V6 |
| 262 | Options Open Interest | B2B Feed | /api/b2b/demo → /api/cap646/262/execute | BOUND | COMPLETE_V6 |
| 263 | Options Volume | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/263/execute | BOUND | COMPLETE_V6 |
| 264 | Options IV / Skew | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/264/execute | BOUND | COMPLETE_V6 |
| 265 | Max Pain / Gamma Context | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/265/execute | BOUND | COMPLETE_V6 |
| 266 | Spot Market Intelligence | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/266/execute | BOUND | COMPLETE_V6 |
| 267 | Order Book / Market Depth | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/267/execute | BOUND | COMPLETE_V6 |
| 268 | Historical Derivatives Data | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/268/execute | BOUND | ENGINEERING_READY |
| 269 | Exchange Comparison | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/269/execute | BOUND | COMPLETE_V6 |
| 270 | Liquidation Cascade Proximity | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/270/execute | BOUND | COMPLETE_V6 |
| 271 | Leverage Pressure Score | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/271/execute | BOUND | COMPLETE_V6 |
| 272 | API Data Platform | B2B Feed | /api/b2b/demo → /api/cap646/272/execute | BOUND | ENGINEERING_READY |
| 273 | Multi-Model Liquidation Comparison | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/273/execute | BOUND | COMPLETE_V6 |
| 274 | Derivatives Alerts | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/274/execute | BOUND | COMPLETE_V6 |
| 275 | Cross-Domain Decision Intelligence | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/275/execute | BOUND | COMPLETE_V6 |
| 276 | Entity Resolution Engine | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/276/execute | BOUND | COMPLETE_V6 |
| 277 | Address Labeling System | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/277/execute | BOUND | COMPLETE_V6 |
| 278 | Entity Profiles | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/278/execute | BOUND | COMPLETE_V6 |
| 279 | Transaction Search | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/279/execute | BOUND | COMPLETE_V6 |
| 280 | Portfolio Holdings | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/280/execute | BOUND | COMPLETE_V6 |
| 281 | Balance History | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/281/execute | BOUND | COMPLETE_V6 |
| 282 | Entity PnL | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/282/execute | BOUND | COMPLETE_V6 |
| 283 | Exchange Usage Intelligence | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/283/execute | BOUND | COMPLETE_V6 |
| 284 | Top Counterparties | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/284/execute | BOUND | COMPLETE_V6 |
| 285 | Visualizer / Network Graph | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/285/execute | BOUND | COMPLETE_V6 |
| 286 | Automated Trace / Path Finding | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/286/execute | BOUND | COMPLETE_V6 |
| 287 | Cross-Chain Trace | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/287/execute | BOUND | COMPLETE_V6 |
| 288 | Token Top Holders | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/288/execute | BOUND | COMPLETE_V6 |
| 289 | Token Exchange Flows | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/289/execute | BOUND | COMPLETE_V6 |
| 290 | Token Transaction Explorer | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/290/execute | BOUND | COMPLETE_V6 |
| 291 | Custom Dashboards | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/291/execute | BOUND | COMPLETE_V6 |
...
| 299 | Cross-Entity Decision Intelligence | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/299/execute | BOUND | COMPLETE_V6 |
| 300 | Advanced Multi-Asset Charting | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/300/execute | BOUND | COMPLETE_V6 |
| 301 | Multi-Chart Layouts | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/301/execute | BOUND | COMPLETE_V6 |
| 302 | Technical Indicator Library | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/302/execute | BOUND | ENGINEERING_READY |
| 303 | Custom Indicator Scripting | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/303/execute | BOUND | COMPLETE_V6 |
| 304 | Strategy Backtesting | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/304/execute | BOUND | COMPLETE_V6 |
| 305 | Market Screener | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/305/execute | BOUND | COMPLETE_V6 |
| 306 | Pine-Style Screener | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/306/execute | BOUND | COMPLETE_V6 |
| 307 | Smart Alerts | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/307/execute | BOUND | COMPLETE_V6 |
| 308 | Watchlists | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/308/execute | BOUND | COMPLETE_V6 |
| 309 | Economic Calendar | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/309/execute | BOUND | COMPLETE_V6 |
| 310 | Crypto Calendar / Events | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/310/execute | BOUND | COMPLETE_V6 |
| 311 | News Integration | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/311/execute | BOUND | COMPLETE_V6 |
| 312 | Heatmaps | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/312/execute | BOUND | COMPLETE_V6 |
| 313 | Technical Ratings | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/313/execute | BOUND | COMPLETE_V6 |
| 314 | Drawing Tools | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/314/execute | BOUND | COMPLETE_V6 |
| 315 | Replay Mode | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/315/execute | BOUND | COMPLETE_V6 |
| 316 | Idea/Chart Sharing | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/316/execute | BOUND | COMPLETE_V6 |
| 317 | Community Scripts | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/317/execute | BOUND | COMPLETE_V6 |
| 318 | Broker Comparison | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/318/execute | BOUND | COMPLETE_V6 |
| 319 | Paper Trading / Simulation | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/319/execute | BOUND | COMPLETE_V6 |
| 320 | Cross-Market Workspace | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/320/execute | BOUND | COMPLETE_V6 |
| 321 | Custom Intelligence Screener | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/321/execute | BOUND | COMPLETE_V6 |
| 322 | Decision-First Mode | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/322/execute | BOUND | COMPLETE_V6 |
| 323 | Institutional L1/L2 Market Data | B2B Feed | /api/b2b/demo → /api/cap646/323/execute | BOUND | COMPLETE_V6 |
| 324 | Reference Data Registry | Public Accuracy Ledger | /api/oracle/audit-chain/verify → /api/cap646/324/execute | BOUND | ENGINEERING_READY |
| 325 | Spot & Derivatives Coverage | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/325/execute | BOUND | COMPLETE_V6 |
| 326 | DeFi Market Data | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/326/execute | BOUND | COMPLETE_V6 |
| 327 | Market Depth & Liquidity Intelligence | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/327/execute | BOUND | COMPLETE_V6 |
| 328 | Fair Market Value Pricing | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/328/execute | BOUND | COMPLETE_V6 |
| 329 | Best Execution Pricing | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/329/execute | BOUND | COMPLETE_V6 |
| 330 | Reference Rates | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/330/execute | BOUND | COMPLETE_V6 |
| 331 | ETF Reference Rates / iNAV | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/331/execute | BOUND | COMPLETE_V6 |
| 332 | Commodity / TradFi Reference Rates | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/332/execute | BOUND | COMPLETE_V6 |
| 333 | Indices | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/333/execute | BOUND | COMPLETE_V6 |
| 334 | Risk Analytics | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/334/execute | BOUND | COMPLETE_V6 |
| 335 | Derivatives Listing Analytics | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/335/execute | BOUND | COMPLETE_V6 |
| 336 | Market Surveillance | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/336/execute | BOUND | COMPLETE_V6 |
| 337 | AML/CFT On-Chain Monitoring | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/337/execute | BOUND | COMPLETE_V6 |
| 338 | Data Quality Pipeline | Public Accuracy Ledger | /api/oracle/audit-chain/verify → /api/cap646/338/execute | BOUND | COMPLETE_V6 |
| 339 | Data Provenance & Audit | Public Accuracy Ledger | /api/oracle/audit-chain/verify → /api/cap646/339/execute | BOUND | ENGINEERING_READY |
| 340 | Real-Time REST/gRPC Streaming | B2B Feed | /api/b2b/demo → /api/cap646/340/execute | BOUND | COMPLETE_V6 |
| 341 | Historical Data Archive | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/341/execute | BOUND | ENGINEERING_READY |
| 342 | Venue Quality Ranking | Public Accuracy Ledger | /api/oracle/audit-chain/verify → /api/cap646/342/execute | BOUND | COMPLETE_V6 |
| 343 | Execution Quality Analytics | Public Accuracy Ledger | /api/oracle/audit-chain/verify → /api/cap646/343/execute | BOUND | COMPLETE_V6 |
| 344 | Institutional SLA Monitoring | B2B Feed | /api/b2b/demo → /api/cap646/344/execute | BOUND | COMPLETE_V6 |
| 345 | Cross-Market Institutional Decision Laye | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/345/execute | BOUND | COMPLETE_V6 |
| 346 | Standardized Financial Metrics | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/346/execute | BOUND | COMPLETE_V6 |
| 347 | Fees Intelligence | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/347/execute | BOUND | COMPLETE_V6 |
| 348 | Revenue Intelligence | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/348/execute | BOUND | COMPLETE_V6 |
| 349 | Token Incentives | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/349/execute | BOUND | COMPLETE_V6 |
| 350 | Earnings / Economic Profit Proxy | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/350/execute | BOUND | COMPLETE_V6 |
| 351 | Active Users | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/351/execute | BOUND | COMPLETE_V6 |
| 352 | Core Developers | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/352/execute | BOUND | COMPLETE_V6 |
| 353 | Code Commits | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/353/execute | BOUND | COMPLETE_V6 |
| 354 | TVL Intelligence | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/354/execute | BOUND | COMPLETE_V6 |
| 355 | Borrowed / Loans Outstanding | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/355/execute | BOUND | COMPLETE_V6 |
| 356 | DEX Volume | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/356/execute | BOUND | COMPLETE_V6 |
| 357 | Stablecoin Supply | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/357/execute | BOUND | COMPLETE_V6 |
| 358 | Valuation Multiples | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/358/execute | BOUND | COMPLETE_V6 |
| 359 | Growth Metrics | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/359/execute | BOUND | COMPLETE_V6 |
| 360 | Margins / Take Rate | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/360/execute | BOUND | COMPLETE_V6 |
| 361 | Project Comparables | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/361/execute | BOUND | COMPLETE_V6 |
| 362 | Sector Comparables | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/362/execute | BOUND | COMPLETE_V6 |
| 363 | Tokenized Asset Coverage | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/363/execute | BOUND | COMPLETE_V6 |
| 364 | Fundamental Screener | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/364/execute | BOUND | COMPLETE_V6 |
| 365 | Financial Statement View | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/365/execute | BOUND | COMPLETE_V6 |
| 366 | Data Methodology Registry | Public Accuracy Ledger | /api/oracle/audit-chain/verify → /api/cap646/366/execute | BOUND | ENGINEERING_READY |
| 367 | Source Data Provenance | Public Accuracy Ledger | /api/oracle/audit-chain/verify → /api/cap646/367/execute | BOUND | ENGINEERING_READY |
| 368 | API / Data Export | B2B Feed | /api/b2b/demo → /api/cap646/368/execute | BOUND | COMPLETE_V6 |
| 369 | Cross-Fundamental Decision Intelligence | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/369/execute | BOUND | COMPLETE_V6 |
| 370 | SQL On-Chain Query Workspace | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/370/execute | BOUND | COMPLETE_V6 |
| 371 | Curated Data Models | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/371/execute | BOUND | COMPLETE_V6 |
| 372 | Decoded Smart Contract Tables | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/372/execute | BOUND | COMPLETE_V6 |
| 373 | Cross-Chain Data Warehouse | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/373/execute | BOUND | COMPLETE_V6 |
| 374 | Visualization Builder | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/374/execute | BOUND | COMPLETE_V6 |
| 375 | Dashboard Builder | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/375/execute | BOUND | ENGINEERING_READY |
| 376 | Public Dashboard Sharing | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/376/execute | BOUND | ENGINEERING_READY |
| 377 | Community Discovery | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/377/execute | BOUND | COMPLETE_V6 |
| 378 | Query Forking | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/378/execute | BOUND | COMPLETE_V6 |
| 379 | Data API | B2B Feed | /api/b2b/demo → /api/cap646/379/execute | BOUND | COMPLETE_V6 |
| 380 | Real-Time Feed | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/380/execute | BOUND | ENGINEERING_READY |
...
| 388 | Alerts from Query Results | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/388/execute | BOUND | COMPLETE_V6 |
| 389 | Data Lineage | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/389/execute | BOUND | COMPLETE_V6 |
| 390 | Query Performance Governance | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/390/execute | BOUND | COMPLETE_V6 |
| 391 | White-Label Embedded Analytics | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/391/execute | BOUND | COMPLETE_V6 |
| 392 | Cross-Domain Decision Layer | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/392/execute | BOUND | COMPLETE_V6 |
| 393 | TVL Intelligence | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/393/execute | BOUND | COMPLETE_V6 |
| 394 | Chain TVL Comparison | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/394/execute | BOUND | COMPLETE_V6 |
| 395 | Protocol Directory | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/395/execute | BOUND | COMPLETE_V6 |
| 396 | Fees & Revenue | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/396/execute | BOUND | COMPLETE_V6 |
| 397 | DEX Volume | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/397/execute | BOUND | COMPLETE_V6 |
...
| 500 | Data Quality & Normalization | Public Accuracy Ledger | /api/oracle/audit-chain/verify → /api/cap646/500/execute | BOUND | COMPLETE_V6 |
| 501 | Institutional Delivery | B2B Feed | /api/b2b/demo → /api/cap646/501/execute | BOUND | COMPLETE_V6 |
| 502 | Benchmark Administration Metadata | B2B Feed | /api/b2b/demo → /api/cap646/502/execute | BOUND | COMPLETE_V6 |
| 503 | Cross-Market Data Intelligence | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/503/execute | BOUND | COMPLETE_V6 |
| 504 | Unified Exchange Connector Layer | B2B Feed | /api/b2b/demo → /api/cap646/504/execute | BOUND | COMPLETE_V6 |
| 505 | Tick Trade Data | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/505/execute | BOUND | COMPLETE_V6 |
| 506 | Quote Data | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/506/execute | BOUND | COMPLETE_V6 |
| 507 | OHLCV | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/507/execute | BOUND | COMPLETE_V6 |
| 508 | L1 Order Book | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/508/execute | BOUND | COMPLETE_V6 |
| 509 | L2 Order Book | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/509/execute | BOUND | COMPLETE_V6 |
| 510 | L3 Order Book | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/510/execute | BOUND | COMPLETE_V6 |
| 511 | Options Market Data | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/511/execute | BOUND | COMPLETE_V6 |
| 512 | Funding / OI / Liquidation Metrics | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/512/execute | BOUND | COMPLETE_V6 |
| 513 | Asset & Symbol Metadata | B2B Feed | /api/b2b/demo → /api/cap646/513/execute | BOUND | COMPLETE_V6 |
| 514 | Historical Flat Files | B2B Feed | /api/b2b/demo → /api/cap646/514/execute | BOUND | ENGINEERING_READY |
| 515 | REST API | B2B Feed | /api/b2b/demo → /api/cap646/515/execute | BOUND | COMPLETE_V6 |
| 516 | WebSocket Streaming | B2B Feed | /api/b2b/demo → /api/cap646/516/execute | BOUND | COMPLETE_V6 |
| 517 | FIX Connectivity | B2B Feed | /api/b2b/demo → /api/cap646/517/execute | BOUND | COMPLETE_V6 |
| 518 | MCP for AI | B2B Feed | /api/b2b/demo → /api/cap646/518/execute | BOUND | COMPLETE_V6 |
| 519 | Exchange Rates / VWAP | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/519/execute | BOUND | COMPLETE_V6 |
| 520 | Indexes | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/520/execute | BOUND | COMPLETE_V6 |
| 521 | Volatility Index | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/521/execute | BOUND | COMPLETE_V6 |
| 522 | EMS Integration Boundary | B2B Feed | /api/b2b/demo → /api/cap646/522/execute | BOUND | COMPLETE_V6 |
...
| 530 | Global Liquidation Metrics | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/530/execute | BOUND | COMPLETE_V6 |
| 531 | Open Interest | B2B Feed | /api/b2b/demo → /api/cap646/531/execute | BOUND | COMPLETE_V6 |
| 532 | Funding Rates | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/532/execute | BOUND | COMPLETE_V6 |
| 533 | Order Flow Intelligence | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/533/execute | BOUND | COMPLETE_V6 |
| 534 | Bucketed CVD | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/534/execute | BOUND | COMPLETE_V6 |
| 535 | Whale vs Retail Flow | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/535/execute | BOUND | COMPLETE_V6 |
| 536 | Slippage Intelligence | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/536/execute | BOUND | COMPLETE_V6 |
| 537 | Global Order Book Metrics | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/537/execute | BOUND | COMPLETE_V6 |
| 538 | Order Book Imbalance | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/538/execute | BOUND | COMPLETE_V6 |
| 539 | Liquidity Zones | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/539/execute | BOUND | COMPLETE_V6 |
| 540 | Bot Activity Detection | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/540/execute | BOUND | COMPLETE_V6 |
| 541 | Market Positioning | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/541/execute | BOUND | COMPLETE_V6 |
| 542 | Liquidation Pressure Score | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/542/execute | BOUND | COMPLETE_V6 |
| 543 | Orderflow Anomaly Detection | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/543/execute | BOUND | COMPLETE_V6 |
| 544 | API Indicator Platform | B2B Feed | /api/b2b/demo → /api/cap646/544/execute | BOUND | COMPLETE_V6 |
| 545 | Trader Cohort Intelligence | Whale Signal vs Noise | /api/whale/signal-vs-noise → /api/cap646/545/execute | BOUND | COMPLETE_V6 |
| 546 | Cross-Derivatives Decision Intelligence | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/546/execute | BOUND | COMPLETE_V6 |
| 547 | High-Resolution Multi-Pane Charts | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/547/execute | BOUND | COMPLETE_V6 |
| 548 | Derivatives Dashboard | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/548/execute | BOUND | ENGINEERING_READY |
| 549 | Funding Rate Intelligence | Arbitrage Scanner | /api/arbitrage/scanner/status → /api/cap646/549/execute | BOUND | COMPLETE_V6 |
| 550 | Open Interest Intelligence | B2B Feed | /api/b2b/demo → /api/cap646/550/execute | BOUND | COMPLETE_V6 |
| 551 | Liquidation Intelligence | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/551/execute | BOUND | COMPLETE_V6 |
| 552 | Futures Volume | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/552/execute | BOUND | COMPLETE_V6 |
| 553 | Basis Intelligence | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/553/execute | BOUND | COMPLETE_V6 |
| 554 | Spot Market Data | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/554/execute | BOUND | COMPLETE_V6 |
| 555 | Options Analytics | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/555/execute | BOUND | COMPLETE_V6 |
| 556 | Options IV Surface | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/556/execute | BOUND | COMPLETE_V6 |
| 557 | Options Skew | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/557/execute | BOUND | COMPLETE_V6 |
| 558 | Options Term Structure | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/558/execute | BOUND | COMPLETE_V6 |
| 559 | TradFi Context | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/559/execute | BOUND | COMPLETE_V6 |
| 560 | Multi-Indicator Workspace | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/560/execute | BOUND | COMPLETE_V6 |
| 561 | Real-Time Prices | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/561/execute | BOUND | COMPLETE_V6 |
| 562 | Historical Data | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/562/execute | BOUND | ENGINEERING_READY |
| 563 | API Data Access | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/563/execute | BOUND | ENGINEERING_READY |
| 564 | News Context | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/564/execute | BOUND | COMPLETE_V6 |
| 565 | Cross-Asset Correlation | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/565/execute | BOUND | COMPLETE_V6 |
| 566 | Derivatives Regime Engine | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/566/execute | BOUND | COMPLETE_V6 |
| 567 | Cross-Market Decision Intelligence | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/567/execute | BOUND | COMPLETE_V6 |
| 568 | Security_First_Architecture | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/568/execute | BOUND | COMPLETE_V6 |
| 569 | API_Security_Encryption | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/569/execute | BOUND | COMPLETE_V6 |
| 570 | High_Availability_Architecture | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/570/execute | BOUND | COMPLETE_V6 |
| 571 | Infrastructure_Uptime_Shield | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/571/execute | BOUND | COMPLETE_V6 |
| 572 | Institutional_Data_Architecture | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/572/execute | BOUND | COMPLETE_V6 |
| 573 | Flexible_Connector_Microservice | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/573/execute | BOUND | COMPLETE_V6 |
| 574 | Institutional_API_Gateway | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/574/execute | BOUND | COMPLETE_V6 |
| 575 | API_Data_Pipe | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/575/execute | BOUND | COMPLETE_V6 |
| 576 | Developer_SDK | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/576/execute | BOUND | COMPLETE_V6 |
| 577 | Pro_Developer_Sandbox | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/577/execute | BOUND | COMPLETE_V6 |
| 578 | Unified_Portfolio_Dashboard | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/578/execute | BOUND | COMPLETE_V6 |
| 579 | Global_Asset_Tracker | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/579/execute | BOUND | COMPLETE_V6 |
| 580 | Multi_Account_Sync | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/580/execute | BOUND | COMPLETE_V6 |
| 581 | On_Chain_Balance_Monitor | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/581/execute | BOUND | COMPLETE_V6 |
| 582 | Profitability_Analyzer | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/582/execute | BOUND | COMPLETE_V6 |
| 583 | Margin_Risk_Calculator | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/583/execute | BOUND | COMPLETE_V6 |
| 584 | Risk_Management_Shield | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/584/execute | BOUND | COMPLETE_V6 |
| 585 | Volatility_Scoring_System | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/585/execute | BOUND | COMPLETE_V6 |
| 586 | Volatility_Surface_Analyzer | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/586/execute | BOUND | COMPLETE_V6 |
| 587 | Delta_Neutral_Calculator | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/587/execute | BOUND | COMPLETE_V6 |
...
| 596 | AI_Agent_Consultant | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/596/execute | BOUND | COMPLETE_V6 |
| 597 | Natural_Language_Interpreter | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/597/execute | BOUND | COMPLETE_V6 |
| 598 | Wallet_Shadowing | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/598/execute | BOUND | COMPLETE_V6 |
| 599 | Entity_Tagging_System | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/599/execute | BOUND | COMPLETE_V6 |
| 600 | Whale_Clustering_Engine | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/600/execute | BOUND | COMPLETE_V6 |
| 601 | Visual_Transaction_Graph | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/601/execute | BOUND | COMPLETE_V6 |
...
| 609 | Funding_Rate_Listener | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/609/execute | BOUND | COMPLETE_V6 |
| 610 | Funding_Arbitrage_Engine | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/610/execute | BOUND | COMPLETE_V6 |
| 611 | Funding_Rate_Heatmap_Engine | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/611/execute | BOUND | COMPLETE_V6 |
| 612 | Spread_Calculation_Engine | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/612/execute | BOUND | COMPLETE_V6 |
| 613 | Liquidation_Screener | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/613/execute | BOUND | COMPLETE_V6 |
| 614 | DEX_Liquidity_Listener | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/614/execute | BOUND | COMPLETE_V6 |
| 615 | Gas_Cost_Predictor | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/615/execute | BOUND | COMPLETE_V6 |
| 616 | Yield_Delta_Listener | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/616/execute | BOUND | COMPLETE_V6 |
| 617 | Yield_Arbitrage_Engine | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/617/execute | BOUND | COMPLETE_V6 |
| 618 | Yield_Optimization_Module | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/618/execute | BOUND | COMPLETE_V6 |
...
| 651 | CAP-651 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/651/execute | BOUND | COMPLETE_V6 |
| 652 | CAP-652 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/652/execute | BOUND | COMPLETE_V6 |
| 653 | CAP-653 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/653/execute | BOUND | COMPLETE_V6 |
| 654 | CAP-654 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/654/execute | BOUND | COMPLETE_V6 |
| 655 | CAP-655 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/655/execute | BOUND | COMPLETE_V6 |
| 656 | CAP-656 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/656/execute | BOUND | COMPLETE_V6 |
| 657 | CAP-657 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/657/execute | BOUND | COMPLETE_V6 |
| 658 | CAP-658 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/658/execute | BOUND | COMPLETE_V6 |
| 659 | CAP-659 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/659/execute | BOUND | COMPLETE_V6 |
| 660 | CAP-660 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/660/execute | BOUND | COMPLETE_V6 |
| 661 | CAP-661 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/661/execute | BOUND | COMPLETE_V6 |
| 662 | CAP-662 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/662/execute | BOUND | COMPLETE_V6 |
| 663 | CAP-663 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/663/execute | BOUND | COMPLETE_V6 |
| 664 | CAP-664 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/664/execute | BOUND | COMPLETE_V6 |
| 665 | CAP-665 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/665/execute | BOUND | COMPLETE_V6 |
| 666 | CAP-666 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/666/execute | BOUND | COMPLETE_V6 |
| 667 | CAP-667 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/667/execute | BOUND | COMPLETE_V6 |
| 668 | CAP-668 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/668/execute | BOUND | COMPLETE_V6 |
| 669 | CAP-669 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/669/execute | BOUND | COMPLETE_V6 |
| 670 | CAP-670 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/670/execute | BOUND | COMPLETE_V6 |
| 671 | CAP-671 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/671/execute | BOUND | COMPLETE_V6 |
| 672 | CAP-672 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/672/execute | BOUND | COMPLETE_V6 |
| 673 | CAP-673 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/673/execute | BOUND | COMPLETE_V6 |
| 674 | CAP-674 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/674/execute | BOUND | COMPLETE_V6 |
| 675 | CAP-675 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/675/execute | BOUND | COMPLETE_V6 |
| 676 | CAP-676 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/676/execute | BOUND | COMPLETE_V6 |
| 677 | CAP-677 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/677/execute | BOUND | COMPLETE_V6 |
| 678 | CAP-678 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/678/execute | BOUND | COMPLETE_V6 |
| 679 | CAP-679 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/679/execute | BOUND | COMPLETE_V6 |
| 680 | CAP-680 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/680/execute | BOUND | COMPLETE_V6 |
| 681 | CAP-681 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/681/execute | BOUND | COMPLETE_V6 |
| 682 | CAP-682 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/682/execute | BOUND | COMPLETE_V6 |
| 683 | CAP-683 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/683/execute | BOUND | COMPLETE_V6 |
| 684 | CAP-684 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/684/execute | BOUND | COMPLETE_V6 |
| 685 | CAP-685 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/685/execute | BOUND | COMPLETE_V6 |
| 686 | CAP-686 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/686/execute | BOUND | COMPLETE_V6 |
| 687 | CAP-687 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/687/execute | BOUND | COMPLETE_V6 |
| 688 | CAP-688 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/688/execute | BOUND | COMPLETE_V6 |
| 689 | CAP-689 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/689/execute | BOUND | COMPLETE_V6 |
| 690 | CAP-690 | B2B Feed | /api/b2b/demo → /api/cap646/690/execute | BOUND | COMPLETE_V6 |
| 691 | CAP-691 | B2B Feed | /api/b2b/demo → /api/cap646/691/execute | BOUND | COMPLETE_V6 |
| 692 | CAP-692 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/692/execute | BOUND | COMPLETE_V6 |
| 693 | CAP-693 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/693/execute | BOUND | COMPLETE_V6 |
| 694 | CAP-694 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/694/execute | BOUND | COMPLETE_V6 |
| 695 | CAP-695 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/695/execute | BOUND | COMPLETE_V6 |
| 696 | CAP-696 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/696/execute | BOUND | COMPLETE_V6 |
| 697 | CAP-697 | Single-Sentence Oracle | /api/oracle/persona-clarity/demo → /api/cap646/697/execute | BOUND | COMPLETE_V6 |
