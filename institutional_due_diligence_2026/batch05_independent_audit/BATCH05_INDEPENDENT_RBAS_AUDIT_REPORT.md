...
**Generated:** 2026-09-11T11:36:23.269291+00:00  
...
- **Tier1 executed:** 14 IDs — 126 phase checks — 13880 ms
- **Tier2 abbreviated:** 28 IDs — 84 phase checks — 9235 ms
- **Tier2 escalated to Tier1:** 8 IDs — 96 phase checks — 27232 ms
...
| 237 | Token Risk Scoring | TIER1 | TIER1_FULL_9_PHASE | **PERFORMANCE-UNVERIFIABLE** | 2 | GIPS (CFA Institute) — full-population performance disclosure | DEDICATED_ONLY | split_brain=DEDICATED_ONLY; runtime success=True surface=token_risk_scoring spine=batch05_prep; code: async def _cap237(*, symbol: str, address: str, params: dict[str, Any]) -> dict[str, Any]:; PERFORMANCE-UNVERIFIABLE: 176 decisions all SIMULATED/SHADOW (2026-09-11T00:30:49.493941+00:00..2026-09-11T11:35:45.1009 | متوسط — |
| 238 | Pump & Dump Detection | TIER1 | TIER1_FULL_9_PHASE | **PERFORMANCE-UNVERIFIABLE** | 2 | GIPS (CFA Institute) — full-population performance disclosure | DEDICATED_ONLY | split_brain=DEDICATED_ONLY; runtime success=True surface=pump_dump_detection spine=batch05_prep; code: async def _cap238(*, symbol: str, address: str, params: dict[str, Any]) -> dict[str, Any]:; PERFORMANCE-UNVERIFIABLE: 176 decisions all SIMULATED/SHADOW (2026-09-11T00:30:49.493941+00:00..2026-09-11T11:35:45.1009 | متوسط — |
...
**CONCEPTUALLY-UNSOUND:** 0/50  
**GIPS ledger:** 176 decisions, simulated_only=True
